...
function print_pemesanan($id) {
    $sql = mysql_query("select p.*, k.nama as karyawan, dp.jumlah, concat_ws(' ',b.nama, b.kekuatan, stn.nama) as nama_barang, 
        ...
        left join satuan stn on (b.satuan_kekuatan = stn.id)
