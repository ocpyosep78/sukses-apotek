...
function add_setting_harga(i) {
    ...
    var row = '<tr class="child'+i+'" id="child'+i+''+j+'"><td></td><td>'+
                '<table width=100% style="border-bottom: 1px dotted #ccc; margin-bottom: 5px; padding-bottom: 3px;">'+
                    ...
                    '<tr><td>Margin Non Resep:</td><td><input type=text name=margin_nr'+i+'[] id=margin_nr'+i+''+j+' size=5 /> <div class="space"> (%) </div> <input type=text id=margin_nr_rp'+i+''+j+' size=5 disabled /></td><td>Harga Jual Non Resep (Rp.):</td><td><input type=text name="hj_nonresep'+i+'[]" id="hj_nonresep_f'+i+''+j+'" size=5 /></td></tr>'+
                    '<tr><td>Margin Resep:</td><td><input type=text name=margin_r'+i+'[] id=margin_r'+i+''+j+' size=5 /> <div class="space"> (%) </div> <input type=text id=margin_r_rp'+i+''+j+' size=5 disabled /></td><td>Harga Jual Resep (Rp.):</td><td><input type=text name="hj_resep'+i+'[]" id="hj_resep_f'+i+''+j+'" size=5 /><img src="img/icons/delete.png" onclick="removeMe(this)" align=right /></td></tr>'+
                '</table>'+
            '</td></tr>';
